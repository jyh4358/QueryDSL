...
public class MemberRepositoryImpl implements MemberRepositoryCustom{
    ...
    public Page<MemberTeamDto> searchPageSimple(MemberSearchCondition condition, Pageable pageable) {
        QueryResults<MemberTeamDto> results = queryFactory
                ...
                .fetchResults();    // 현재는 deprecate 됨, fetch 사용 권장(count 쿼리때문에 성능이 문제 발생)

        List<MemberTeamDto> content = results.getResults(); // 검색 결과
        long total = results.getTotal();    // 총 검색 결과 개수
...
//                .leftJoin(member.team, team)
    ...
    private List<MemberTeamDto> getMemberTeamDtos(MemberSearchCondition condition, Pageable pageable) {
        List<MemberTeamDto> content = queryFactory
                ...
                .offset(pageable.getOffset())   // 페이지 번호
                .limit(pageable.getPageSize())  // 페이지 사이즈
                .fetch();// 현재는 deprecate 됨, fetch 사용 권장(count 쿼리때문에 성능이 문제 발생)
        return content;
    }
